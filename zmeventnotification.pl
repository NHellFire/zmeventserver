...
use CONSTANT_DEFAULT_PWAUTH_ENABLE => 0;
use CONSTANT_DEFAULT_PWAUTH_GROUP => 'sudo';
use CONSTANT_DEFAULT_PWAUTH_BINARY => '/usr/sbin/pwauth';
...
$pwauth_enabled //= config_get_val($config, "pwauth", "enable",  DEFAULT_PWAUTH_ENABLE);
$pwauth_group //= config_get_val($config, "pwauth", "group", DEFAULT_PWAUTH_GROUP);
$pwauth_binary //= config_get_val($config, "pwauth", "binary",  DEFAULT_PWAUTH_BINARY);
...
pwauth enabled ................ ${\(true_or_false($pwauth_enabled))}
pwauth group .................. ${\(value_or_undefined($pwauth_group))}
pwauth binary ................. ${\(value_or_undefined($pwauth_binary))}
